...
|---|---|
| I Got Connections | Enter the hidden phrase during the PIN mini-game |
...
- [portable-file-dialogs](https://github.com/samhocevar/portable-file-dialogs) — drop `portable-file-dialogs.h` in the project root

## Building

### Visual Studio

1. Create a new **Empty C++ Console App** project.
2. Add `atlas_game.cpp` and `portable-file-dialogs.h` to the project.
...
MIT — see `LICENSE`, or add one if you haven't yet.
